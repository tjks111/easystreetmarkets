...
export function generateIntersectionEditorial(
  ...
  const lookForByCategory: Record<string, string> = {
    ...
    "art-prints": `Wildlife art prints range from mass-market posters to gallery-quality giclée prints. Look for: archival inks, acid-free paper, stated paper weight (200gsm+ for quality), and edition information. An unsigned open-edition print at $15 is fundamentally different from a signed limited-edition giclée at $120. For the ${animalLower}, prefer artists who have actually observed the animal — many wildlife illustrators work from reference photos and field notes, and it shows. Frame sizing is the other common pitfall: prints listed as "A3" or "16x20" often arrive with white borders that eat into those dimensions.`,
